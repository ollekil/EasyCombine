...
struct Character {
    ...
    static let allCharacters: [Character] = [
        Character(id: 0, name: "초급", title: "초급 모험가!", message: "아직은 낯설지만,기초를 튼튼하게 다질 시간!", description: "초보자 전용 튜토리얼"),
        Character(id: 1, name: "중급", title: "중급 도전자!", message: "이제 직접 코드를 작성하며 실력을 키울 차례!", description: "본격적인 전투 돌입"),
        Character(id: 2, name: "고급", title: "고급 챌린저!", message: "실제 프로젝트를 만들며 실전 경험을 쌓아라!", description: "실전 보스전 돌입")
    ]
